		...
		<div className="w-[100%] px-[20px] py-[20px] bg-dark-blue rounded-[10px] flex flex-col gap-[20px] max-800:w-[100%]">
			...
			<div className="flex gap-[40px]  max-650:gap-[25px] max-480:gap-[15px]">
				...
				<div className="Report max-480:gap-[15px] max-370:gap-[12px]">
					<span className="Report-text h-[25px] max-650:h-[19px] max-480:h-[15px]">
						Severity
					</span>
				...
				<div className="Report gap-[20px] max-650:gap-[10px]">
					...
					<span className="Report-color-box text-orange-400 bg-opacity-15 bg-orange-600 border border-orange-500">
						0
					</span>
					<span className="Report-color-box text-green-300 bg-opacity-15 bg-green-300 border border-green-300">
						0%
					</span>
					<span className="Report-color-box text-blue-500 bg-opacity-15 bg-blue-500 border border-blue-500">
						0%
					</span>
					<span className="Report-color-box text-red-300 bg-opacity-15 bg-red-300 border border-red-300">
						0
					</span>
				</div>
			</div>
